...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/Elegying/AnyTLS_Panel/v1.2.0/deploy.sh)
```
...
```bash
gh release verify v1.2.0 --repo Elegying/AnyTLS_Panel
gh release verify-asset v1.2.0 AnyTLS_Panel-v1.2.0.tar.gz \
  --repo Elegying/AnyTLS_Panel
sha256sum -c AnyTLS_Panel-v1.2.0.tar.gz.sha256
cosign verify-blob \
  --bundle AnyTLS_Panel-v1.2.0.tar.gz.sigstore.json \
  --certificate-identity "https://github.com/Elegying/AnyTLS_Panel/.github/workflows/release.yml@refs/tags/v1.2.0" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com" \
  AnyTLS_Panel-v1.2.0.tar.gz
```

### 方式二：克隆部署

```bash
git clone --depth 1 --branch v1.2.0 https://github.com/Elegying/AnyTLS_Panel.git
cd AnyTLS_Panel
bash deploy.sh
```
